...
class RegistrazionePage {
      ...
      privacyCheckbox.addEventListener("change", () => {
        if (!privacyCheckbox.disabled) {
          ...
          ShowModal.showModalInfo(
            "Hai già accettato la Privacy Policy. Non puoi deselezionarla.",
            "Attenzione"
          );
        }
      });
      ...
      if (response.ok) {
        ...
        if (errorData.error === "Email già registrata") {
          ShowModal.showModalError(
            "L'email inserita è già registrata. Prova con un'altra email.",
  ...
  setupPrivacyOverlay() {
    ...
    acceptBtn.addEventListener("click", () => {
      ...
      ShowModal.showModalInfo(
        "Grazie per aver accettato la Privacy Policy. Ora puoi procedere con la registrazione.",
