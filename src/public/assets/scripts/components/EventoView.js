...
class EventoView {
  ...
  setupScrollAnimations() {
    ...
    const animateElements = this.container.querySelectorAll(
      ".event-details-card, .event-description-card"
    );
  ...
  showNotification(message) {
    ...
    try {
      if (
        ...
        typeof window.AdminGlobal.ToastManager.success === "function"
      ) {
      ...
      if (
        ...
        typeof toastManager.success === "function"
      ) {
