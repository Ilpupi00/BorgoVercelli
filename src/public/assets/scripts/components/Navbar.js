class Navbar {
  ...
  async render() {
    ...
    navUl.className =
      "navbar-nav mb-3 mb-lg-0 ms-auto align-items-center justify-content-center";
    ...
    if (isLogged) {
      ...
      profileLink.className =
        "text-light d-flex justify-content-center align-items-center w-100";
      ...
      loginBtn.className =
        "btn btn-outline-light d-flex align-items-center justify-content-center gap-2 mx-auto mx-lg-0";
      loginBtn.id = "Login";
