...
Cordiali saluti`);
    ...
    try {
      ...
      if (response.ok) {
        ...
        this.mostraMessaggio(
          "Errore nel caricamento dei dettagli del membro",
          "danger"
        );
      }
    } catch (error) {
                        ...
                        <div class="modal-body">
                            <form id="contactForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="contactMessage" rows="4" required>${decodeURIComponent(
                                      body
                                    )}</textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <span class="badge role-badge role-${membro.ruolo
                                          .toLowerCase()
                                          .replace(/\s+/g, "-")} ms-2">${
      membro.ruolo
    }</span>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="contattaMembro('${
                              membro.email
                            }')">
  ...
  mostraMessaggio(messaggio, tipo = "info") {
    ...
    const toastContainer =
      this.page.querySelector(".toast-container") || this.creaToastContainer();
  ...
  setupParallax() {
    ...
    const heroElements = this.page.querySelectorAll(
