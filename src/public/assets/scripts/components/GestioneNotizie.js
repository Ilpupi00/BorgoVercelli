class GestioneNotizie {
  ...
  initialize() {
    ...
    console.log(
      "Gestione notizie caricata con",
      this.notizieCards.length,
      "notizie"
    );
  }
  ...
  loadNotizieData() {
    ...
    const rows = document.querySelectorAll(
      "#notizieTableBody tr[data-notizia-id]"
    );
  ...
  updateEmptyState(visibleCount) {
    ...
    let emptyState = notizieList
      ? notizieList.querySelector(".empty-state.filter-empty")
      : null;
        ...
        const handleDelete = async () => {
          ...
          try {
            ...
            if (response.ok && result.success) {
              ...
              this.originalNotizie = this.originalNotizie.filter(
                (n) => n.id !== id
              );
...
window.clearAllFilters = function () {
  if (
    typeof gestioneNotizie !== "undefined" &&
    gestioneNotizie &&
    typeof gestioneNotizie.clearAllFilters === "function"
  ) {
