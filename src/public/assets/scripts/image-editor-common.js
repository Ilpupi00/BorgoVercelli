...
function bindImageEditorButtons() {
  ...
  document.addEventListener("click", (e) => {
    ...
    if (editBtn) {
      e.preventDefault();
      const imageUrl =
        editBtn.dataset.imageUrl ||
        editBtn.closest(".image-preview-wrapper").querySelector("img")?.src;
      if (imageUrl) {
      ...
      try {
        ...
        canvas.toBlob(
          async (blob) => {
            ...
            const currentImagePreview = document.querySelector(
            ...
            if (eventoForm) {
              ...
              if (
                eventoId &&
                typeof window.uploadImageToServer === "function"
              ) {
                console.log(
                  "📤 Upload automatico immagine modificata per evento ID:",
                  eventoId
                );
            ...
            if (notiziaForm) {
              ...
              if (
                ...
                console.log(
                  "📤 Upload automatico immagine modificata per notizia ID:",
                  notiziaId
                );
            ...
            if (
              eventoForm?.getAttribute("data-evento-id") ||
              notiziaForm?.getAttribute("data-notizia-id")
            ) {
              showSuccessToast("Modifiche salvate e caricate con successo!");
            } else {
              showSuccessToast(
                "Modifiche salvate! Salva il form per applicare le modifiche."
              );
            }
          },
          "image/jpeg",
