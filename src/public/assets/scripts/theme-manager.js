...
if (typeof ThemeManager !== "undefined") {
  ...
  class ThemeManager {
    ...
    updateThemeUI() {
      ...
      if (lightBtn)
        lightBtn.classList.toggle("active", savedTheme === this.themes.LIGHT);
      if (darkBtn)
        darkBtn.classList.toggle("active", savedTheme === this.themes.DARK);
      if (autoBtn)
        autoBtn.classList.toggle("active", savedTheme === this.themes.AUTO);
