...
(function () {
  ...
  const FESTE_ITALIANE = {
    capodanno: {
      ...
      saluto: "Buon Anno!",
      messaggio:
        "Ti auguriamo un fantastico {anno} pieno di gol, vittorie e soddisfazioni sportive!<br>Che questo nuovo anno porti successi a te e alla nostra società!",
    ...
    epifania: {
      ...
      messaggio:
        "La Befana porta dolci a chi è stato bravo...<br>e voi siete stati fantastici! Grazie per far parte della nostra famiglia sportiva!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    carnevale: {
      nome: "Carnevale",
      ...
      messaggio:
        "Ogni scherzo vale! Divertiti e festeggia con allegria!<br>La nostra società ti augura un Carnevale pieno di gioia e colori!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    pasqua: {
      nome: "Pasqua",
      ...
      saluto: "Buona Pasqua!",
      messaggio:
        "Ti auguriamo una Pasqua serena e piena di gioia insieme ai tuoi cari!<br>Che questa festività porti rinnovata energia per tornare in campo!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    liberazione: {
      ...
      messaggio:
        "Ricordiamo con gratitudine chi ha lottato per la nostra libertà.<br>Buon 25 Aprile a tutta la nostra comunità sportiva!",
    ...
    lavoratori: {
      ...
      messaggio:
        "Auguri a tutti i lavoratori che ogni giorno si impegnano con dedizione!<br>La nostra società celebra il valore del lavoro e dell'impegno!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    repubblica: {
      ...
      messaggio:
        "Celebriamo insieme i valori della nostra Repubblica!<br>Auguri a tutta la comunità sportiva italiana!",
      chiusura: "Viva l'Italia! ⚽",
    },
    ferragosto: {
      nome: "Ferragosto",
      check: (data) =>
        data.getMonth() === 7 && data.getDate() >= 13 && data.getDate() <= 16,
      periodo: "15 agosto",
      colori: {
        primary: "#FF9800",
        secondary: "#03A9F4",
      ...
      messaggio:
        "Ti auguriamo un Ferragosto ricco di sole, mare e relax!<br>Goditi le vacanze estive e ricarica le energie per la nuova stagione!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    ognissanti: {
      nome: "Ognissanti",
      ...
      messaggio:
        "Un momento di riflessione e ricordo per chi non c'è più.<br>La nostra società è vicina a tutti in questo giorno speciale.",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    immacolata: {
      ...
      messaggio:
        "Auguri per questa festa speciale che segna l'inizio del periodo natalizio!<br>La nostra società ti augura serenità e gioia!",
      chiusura: "Ci vediamo in campo! ⚽",
    },
    natale: {
      nome: "Natale",
      ...
      messaggio:
        "A nome di tutta la A.S.D. Borgo Vercelli 2022, vi auguriamo un Natale sereno e pieno di gioia.<br>Grazie per far parte della nostra comunità sportiva!",
  ...
  function mostraModalFesta() {
    ...
    console.log(
      `Modal per ${festaCorrente.nome} ${anno} mostrato con successo`
    );
  }
