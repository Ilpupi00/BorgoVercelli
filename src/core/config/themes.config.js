...
const THEMES = {
  ...
  dark: {
    id: "dark",
    nome: "Tema Scuro",
    descrizione: "Tema notturno con sfondo scuro e accenti cyan",
    icona: "bi-moon-stars-fill",
    colori: {
      primary:            "#4a9eff",
      primary_hover:      "#5dadff",
      secondary:          "#3cc566",
      success:            "#10b981",
      danger:             "#ef4444",
      warning:            "#f59e0b",
      ...
      card_border:        "#334155",
      card_shadow:        "0 6px 18px rgba(3,9,23,0.6)",
      btn_primary_bg:     "#4a9eff",
      btn_primary_text:   "#0f172a",
      btn_primary_hover:  "#5dadff",
      input_border:       "#334155",
      input_bg:           "#1e293b",
      input_text:         "#f1f5f9",
      navbar_bg:          "linear-gradient(135deg,#1e3a8a 0%,#1d4ed8 100%)",
      navbar_text:        "#ffffff",
      footer_bg:          "#1e293b",
      footer_text:        "#94a3b8",
      gradient_primary:   "linear-gradient(135deg,#1e3a8a 0%,#2563eb 100%)",
      gradient_success:   "linear-gradient(135deg,#065f46 0%,#059669 100%)",
    },
  },
