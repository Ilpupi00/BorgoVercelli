...
class Giocatore {
  ...
  static from(json) {
    ...
    giocatore.data_inizio_tesseramento = new Date(
      json.data_inizio_tesseramento
    );
  ...
  static to(giocatore) {
    ...
    json.data_inizio_tesseramento = giocatore.data_inizio_tesseramento
      .toISOString()
      .split("T")[0];
    json.data_fine_tesseramento = giocatore.data_fine_tesseramento
      .toISOString()
      .split("T")[0];
    return json;
  }
