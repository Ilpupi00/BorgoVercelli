...
class Prenotazione {
  ...
  static from(json) {
    ...
    // Formatta timestamp
    prenotazione.created_at = moment(json.created_at).format(
      "YYYY-MM-DD HH:mm:ss"
    );
    prenotazione.updated_at = moment(json.updated_at).format(
      "YYYY-MM-DD HH:mm:ss"
    );
    return prenotazione;
  }
  ...
  static to(prenotazione) {
    ...
    // Formatta timestamp
    json.created_at = moment(prenotazione.created_at).format(
      "YYYY-MM-DD HH:mm:ss"
    );
    json.updated_at = moment(prenotazione.updated_at).format(
      "YYYY-MM-DD HH:mm:ss"
    );
    return json;
  }
