...
class Campionato {
  ...
  static from(json) {
    ...
    // Formatta timestamp
    campionato.created_at = json.created_at
      ? moment(json.created_at).format("YYYY-MM-DD HH:mm:ss")
      : null;
    campionato.updated_at = json.updated_at
      ? moment(json.updated_at).format("YYYY-MM-DD HH:mm:ss")
      : null;
    return campionato;
  }
  ...
  static to(campionato) {
    ...
    // Formatta timestamp
    json.created_at = campionato.created_at
      ? moment(campionato.created_at).format("YYYY-MM-DD HH:mm:ss")
      : null;
    json.updated_at = campionato.updated_at
      ? moment(campionato.updated_at).format("YYYY-MM-DD HH:mm:ss")
      : null;
    return json;
  }
}
