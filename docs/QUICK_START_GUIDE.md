...
🔄 Sistema - Segue le tue impostazioni
```
...
Cards luminose      →  Cards scure eleganti
Ombre leggere       →  Ombre profonde
```
...
4. **Risparmia batteria su schermi OLED** 🔋
...
**Q: Il tema rimane quando ricarico la pagina?**  
A: Sì! La tua scelta viene salvata automaticamente.

**Q: Funziona su mobile?**  
A: Assolutamente! Perfettamente responsive.

**Q: Posso usare tasti rapidi?**  
A: Presto! Stiamo lavorando sui keyboard shortcuts.

**Q: Influisce sulle performance?**  
A: No! Il cambio è istantaneo e senza lag.

**Q: È accessibile?**  
A: Sì! Rispetta gli standard WCAG per il contrasto.

## Visual Guide

```
┌─────────────────────────────────────┐
│  🏠 Borgo Vercelli    [🔍] [👤] [☀️] │  ← Click qui!
├─────────────────────────────────────┤
│                                     │
│                                     │
│         ┌─────────────┐            │
