(async () => {
  ...
  const mockNotizie = [
    {
      id: 101,
      data_pubblicazione: "2025-11-01T12:00:00Z",
      data_modifica: "2025-11-10T12:00:00Z",
      created_at: "2025-11-01T12:00:00Z",
    },
    {
      id: 102,
      data_pubblicazione: "2025-10-15T12:00:00Z",
      data_modifica: null,
  ...
  const server = app.listen(port, async () => {
    ...
    try {
      const res = await axios.get(`http://localhost:${port}/sitemap.xml`, {
        responseType: "text",
      });
      const text = res.data;
