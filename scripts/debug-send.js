...
(async () => {
  try {
    ...
    const res = await db.query(
      "SELECT id, endpoint, p256dh, auth, user_id FROM push_subscriptions ORDER BY created_at DESC LIMIT 1"
    );
    ...
    console.log(
      "Sending to endpoint (truncated):",
      sub.endpoint.substring(0, 120) + "..."
    );
