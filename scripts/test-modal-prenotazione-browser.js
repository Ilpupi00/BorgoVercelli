...
if (modal) {
  ...
  const campi = {
    ...
    tipoDocumentoPrenotazione: modal.querySelector(
      "#tipoDocumentoPrenotazione"
    ),
    codiceFiscalePrenotazione: modal.querySelector(
      "#codiceFiscalePrenotazione"
    ),
    numeroDocumentoPrenotazione: modal.querySelector(
      "#numeroDocumentoPrenotazione"
    ),
  ...
  console.log(
    '   Soluzione: Clicca su "Prenota" per un campo e riesegui questo test'
  );
}
